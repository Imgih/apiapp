...
export default function App() {  
  ...
  useEffect( () => { /* efeito colateral - quando for verdadeiro vai fazer o efeito colateral */
    if (isShaking) {
      handleToggleCamera() 
    }
  }, [isShaking]) /* Colchetes vazios, na vida util ele vai funcionar (dependencias), o react vai notificar*/
